...
with open('samJ7_file_list_machineTime.csv','r') as csvfile1:
    #with open('moto_file_list_machineTime.csv','r') as csvfile2:
        #with open('samJ7_file_list_machineTime.csv','r') as csvfile3:
            ...
            samJ7 = csv.reader(csvfile1, delimiter = '\n')

            maxLen = 6000
            datas = np.zeros([1,maxLen])
            ...
            plt.xlim(left=1664835521625,right=1665441744561)
